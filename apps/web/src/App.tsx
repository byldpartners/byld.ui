      ...
      <div className="mx-auto max-w-2xl space-y-8">
        ...
        <Section title="Sidebar">
          <SidebarProvider defaultOpen={true}>
            <div className="flex h-48 rounded-lg border overflow-hidden" style={{ "--sidebar-width": "180px" } as React.CSSProperties}>
              <Sidebar>
                <SidebarHeader>
                ...
                <SidebarContent>
                  <nav className="space-y-1">
                    <a href="#" className="block text-sm px-2 py-1 rounded hover:bg-accent">Home</a>
                    <a href="#" className="block text-sm px-2 py-1 rounded hover:bg-accent">Settings</a>
                    <a href="#" className="block text-sm px-2 py-1 rounded hover:bg-accent">Profile</a>
                  </nav>
                </SidebarContent>
                <SidebarFooter>
              ...
              <div className="flex-1 p-4 flex items-center justify-center">
                <SidebarTrigger />
                <span className="text-sm text-muted-foreground ml-2">Main content</span>
              </div>
            </div>
          </SidebarProvider>
        </Section>
